...
function initWidget(waifuPath = "/waifu-tips.json", apiPath = "") {
  // 原768
	if (screen.width <= 10 || (localstorage.getitem("waifu-display") && new date().gettime() - localstorage.getitem("waifu-display") <="86400000))" { return; } localstorage.removeitem("waifu-display"); sessionstorage.removeitem("waifu-text"); $("body").append(`<div id="waifu">
